...
<%@page import="mysimpleprojects.restaurant.beans.Login"%>
<%@page import="mysimpleprojects.restaurant.beans.OrderMaster.OrderStatus"%>
<%@page import="mysimpleprojects.dao.CookServices"%>
<%@page import="mysimpleprojects.restaurant.beans.OrderMaster"%>
<%@page import="mysimpleprojects.restaurant.beans.Item"%>
<%@page import="mysimpleprojects.restaurant.beans.Category"%>
<%@page import="mysimpleprojects.dao.UserService"%>
<%@page import="java.util.ArrayList"%>
<%@page import="mysimpleprojects.constants.GlobalConstants"%>
<%! 
